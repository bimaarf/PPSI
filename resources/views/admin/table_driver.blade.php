        ...
        <div class="card-body">
            <div class="fs-5">
                ...
                <form class="d-none d-md-flex input-group w-auto my-auto fa-pull-right"
                    action="{{ route('admin.table_driver') }}">
                        ...
                        @foreach ($users as $items)
                            <tr>
                                ...
                                @if ($items->status_id == 2)
                                    <td><a href="" class="btn btn-danger shadow-none btn-sm rounded-6 text-capitalize">Tidak Aktif</a>
                                    </td>
                                @endif
                                ...
                                <td>
                                    <div class="btn-group shadow-none" role="group" aria-label="Basic example">
                                        <button type="button" class="btn btn-info shadow-none" data-mdb-toggle="modal"
                                ...
                                <div class="modal-dialog modal-lg  modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('admin.edit_driver', ['id' => $items->id]) }}"
                                                method="POST">
                                                @csrf
                                                <div class="row mt-2">
                                                    <div class="col-lg-6">
                                                                ...
                                                                <select name="status_id" id="status_id"
                                                                    ...
                                                                    @foreach ($users_status as $status)
                                                                        <option value="{{ $status->id }}"
                                                                            {{ $items->status_id == $status->id ? 'selected' : '' }}>
                                        ...
                                        <div class="modal-footer">
                                            <a href="https://wa.me/{{ $items->telp }}?text=Hallo {{ $items->name }},"
