        ...
        <div class="card-header">
            ...
            <div class="fa-pull-right" style="width: 300px">
                <form class="d-none d-md-flex input-group w-auto my-auto" action="{{ route('admin.table_driver') }}">
                    <input type="text" value="{{ request('search') }}" class="form-control" name="search" id="search-bar" placeholder='Cari username'
                                ...
                                <div class="modal-dialog modal-lg  modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('admin.edit_user', ['id'=>$items->id]) }}" method="POST">
                                                @csrf
                                                <div class="row mt-2">
                                                    <div class="col-lg-6">
