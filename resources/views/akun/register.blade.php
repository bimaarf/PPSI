...
<body>
    ...
    <div class="card rounded shadow mx-auto row card-akun">
        ...
        <div class="col-lg-6 col-md-6 card-body p-5 body-akun">
            <h2 class="card-title mt-5 text-center">Daftar</h2>
            <form action="" class="login-form mx-md-2 mx-lg-4">
                ...
                <div class="form-group mx-sm-0 mx-md-4 mx-lg-4 row align-items-center check">
                    <div class="form-check col-sm-6 col-md-7 col-lg-7 p-0 remember order-2 order-sm-1">
                        Sudah punya akun? <a href="#">Masuk</a>
                    </div>
                    <div class="col-5 px-0 login-button order-1 order-sm-2">
