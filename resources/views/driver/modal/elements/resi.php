<div class="row fs-5">
    ...
    <div class="col-7 py-lg-2">
        &emsp;&emsp;&emsp;<b class="text-capitalize">{{ $item->orders->nama_pengirim }}</b>
    </div>
    ...
    <div class="col-7 py-lg-2">
        &emsp;&emsp;&emsp;{{ $item->orders->nama_barang }}
    </div>
    ...
    <div class="col-7 py-lg-2">
        &emsp;&emsp;&emsp;{{ $item->orders->jenis_barang }}
    </div>
    ...
    <div class="col-7 py-lg-2">
        &emsp;&emsp;&emsp;{{ $item->orders->jemput }}
    </div>
    ...
    <div class="col-7 py-lg-2">
        &emsp;&emsp;&emsp;{{ $item->orders->alamat_jemput }}
    </div>
    ...
    <div class="col-7 py-lg-2">
        &emsp;&emsp;&emsp;{{ $item->orders->jadwal }}&emsp;{{ $item->orders->start_time }}&nbsp;s/d&nbsp;{{ $item->arrival_time }}&nbsp;WIB
    </div>
