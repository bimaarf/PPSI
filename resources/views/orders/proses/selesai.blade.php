...
<li class="complete prev-step">
    <a href="#">Driver menuju ke {{ $item->orders->alamat_jemput }}<i class="ico fa fa-check ico-green"></i>
        <span class="desc">Paket akan segera dijemput</span>
    </a>
</li>
<li>
...
<li class="complete prev-step">
    <a href="#">Driver menuju ke lokasi {{ $item->orders->alamat_jemput }}<i class="ico fa fa-check ico-green"></i>
        <span class="desc">{{ $track->updated_at }} - Paket akan segera dijemput</span>
    </a>
</li>
<li class="complete prev-step">
    <a href="#">Driver sampai di lokasi {{ $item->orders->alamat_jemput }}<i class="ico fa fa-check ico-green"></i>
