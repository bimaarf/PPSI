  <div class="modal top fade" id="proses{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                  ...
                  <div class="row">
                      <div class="col-lg-9">
                          <div class="tab-content" id="ex1-content">
                              ...
                              <div class="tab-pane fade" id="ex1-resi-2{{ $item->id }}" role="tabpanel"
                                  ...
                                  <div class="row" id="timeline{{ $item->id }}"></div>
                      ...
                      <ul class="col-lg-3 nav nav-tabs mb-3 nav-item" id="ex1" role="tablist">
                          <li class=" nav-link" role="presentation">
                              ...
                              <a class="btn btn-lg btn-success rounded-5 btn-lg mt-1 text-capitalize" id="ex1-tab-2"
                                  data-mdb-toggle="tab" href="#ex1-resi-2{{ $item->id }}"
                                  onclick="bute({{ $item->id }})" role="tab"
                                  aria-controls="ex1-tabs-2{{ $item->id }}" aria-selected="false"
                                  style="width: 100%">Lacak Pesanan</a>
  ...
  <script>
      function bute(id) {
          const url = "/orders/modal-track/" + id
          const query = "#timeline" + id
