...
<div class="row mt-2">
    <div class="col-lg-5">
        <div class="card rounded-9">
            <div class="text-center">
                <img src="{{ asset('assets/icon/Shipper.svg') }}" class="img-fluid rounded mt-4" width="200vh"
                    alt="">
    ...
    <div class="col-lg-7">
        ...
        <div class="card rounded-9 mt-2">
            <div class="card-header">
                <div class="row">
                    <a href="{{ route('orders.form_1') }}" class="btn btn-primary text-capitalize col-lg-12 rounded-9">Pesan Armada</a>
                </div>
            </div>
        </div>
        <div class="card rounded-9 mt-2">
