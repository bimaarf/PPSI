...
// shipper
Route::get('/dashboard', [ShipperController::class, 'dashboard'])->name('user.index')->middleware(['auth', 'role:shipper']);
// shipper akses
...
// driver
Route::get('/dashboard/driver', [DriverController::class, 'dashboardDriver'])->name('driver.index')->middleware(['auth', 'role:driver']);
